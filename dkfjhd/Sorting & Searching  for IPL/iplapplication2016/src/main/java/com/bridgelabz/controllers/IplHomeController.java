...
/*//--------display the Delhi DareDevils team list in Json By using @RestController-------- 
		@RequestMapping(value="ddTeamPlayer", method = RequestMethod.GET,produces = "application/json")
		public String DDTeamList() throws IOException
		{
			ArrayList<?> ddTeamPlayer=new ArrayList<Object>();
			ddTeamPlayer= play.printList();
			   ObjectMapper mapper = new ObjectMapper();
			   return mapper.writerWithDefaultPrettyPrinter().writeValueAsString(ddTeamPlayer);
		}*/
